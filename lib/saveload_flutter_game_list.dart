...
class _GameCenterSelectedListState extends State<GameCenterSelectedList> {
      ...
      return Expanded(
        child: Center(
          child: Column(
            ...
            children: [
              Icon(Icons.games, size: 64, color: Colors.grey[300]),
        ...
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: isSelected ? Colors.blue[50] : Colors.purple[100],
  ...
  Widget _buildAddButton() {
    if (kIsWeb) {
      return IconButton(icon: const Icon(Icons.add), color: Colors.grey, onPressed: null);
    } else {
      return IconButton(
        ...
        onPressed: () async {
          await showDialog(
            ...
            builder: (context) => Dialog(
              child: Container(padding: EdgeInsets.all(20), child: GamePicker()),
            ),
          );
          await _loadGameList();
        },
